          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6 content">
                ...
                <h3>
                  Hoạ sĩ Phan Nguyễn, người đồng hành cũng bạn trong khoá học
                  này là họa sĩ chuyên nghiệp từ 2007.
                </h3>
                <p>
                  Các bài giảng dạy vẽ các con vật và nhân vật hoạt hình từ
                  những đường nét cơ bản nhất nên rất phù hợp với trẻ, giúp bé
                  làm quen với cách tạo hình nhân vật và là tiền đề để bé có thể
                  tiếp tục học vẽ nghệ thuật sau này. Bé sẽ được học 3 dáng vẽ
                  khác nhau cho từng con vật hay nhân vật để tăng sự đa dạng cho
                  bài học và để bé có thể biết cách tự sáng tạo dáng vẽ theo ý
                  muốn của mình.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="box wow fadeInLeft">
                  ...
                  <p className="description">
                    Vẽ giúp bé cải thiện trí nhớ, và ngạc nhiên hơn là vẽ giúp
                    bé biết cách quan sát mọi việc trong cuộc sống tinh tế hơn,
                    sâu sắc hơn.
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="box wow fadeInRight">
                  ...
                  <p className="description">
                    Vẽ giúp bé nâng cao khả năng tưởng tượng - tăng cường tính
                    sáng tạo; thúc đẩy khả năng tư duy, suy nghĩ đa chiều của
                    bé.
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="box wow fadeInLeft" data-wow-delay="0.2s">
                  ...
                  <p className="description">
                    Bé sẽ thoải mãi thể hiện, bộc bạch những suy nghĩ, cảm xúc
                    của mình qua từng bức vẽ. Vẽ cũng giúp bé cảm thấy phấn chấn
                    và yêu đời hơn nhiều.
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="box wow fadeInRight" data-wow-delay="0.2s">
                  ...
                  <p className="description">
                    Khoá học cũng sẽ giúp bé thoả thích cover lại các nhân vật
                    và tuỳ biến họ về mặt cảm xúc,cử chỉ.
                    <br />
                  </p>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-9 text-center text-lg-left">
                ...
                <p className="cta-text">
                  Cùng hợp tác xây dựng các khóa học online để chia sẻ kiến thức
                  và kinh nghiệm của bạn với mọi người
                </p>
              </div>
